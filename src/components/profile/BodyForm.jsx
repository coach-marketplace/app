...
import { TextInputField, Alert, RadioGroup, SegmentedControl, Text } from "evergreen-ui";
...
import { 
    ...
    UPDATE_USER_BODY_INFOS_SUCCESS } from "../../store/modules/user/constants"

import { fetchUserBodyInfos, updateUserBodyInfos } from "../../store/modules/user/user";
...
class BodyForm extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {};
        this.onBodyChangeSubmitted = this.onBodyChangeSubmitted.bind(this);
    }
        ...
        return(
            <form key={1} onSubmit={this.onBodyChangeSubmitted}>
                        <TextInputField
                            ...
                            onChange={ (event) => this.props.bodyData.height = event.target.value }
                        />
                        <SegmentedControl
                        ...
                        <TextInputField
                            ...
                            onChange={ (event) => this.props.bodyData.weight = event.target.value }
                        />
                        <SegmentedControl
    ...
    render() {
        ...
        switch(this.props.bodyData.status){
            case FETCH_USER_BODY_INFOS_PENDING || UPDATE_USER_BODY_INFOS_PENDING :
                return(<Spinner />)
            case FETCH_USER_BODY_INFOS_ERROR || UPDATE_USER_BODY_INFOS_ERROR :
                return(
                    <Alert
                        intent="danger"
